...
if aReverse[0] == "0" && aReverse[1] == "/" {print("Нельзя делить на ноль")}

else if a.contains("/0*") || a.contains("/0/") || a.contains("/0+") || a.contains("/0-") || a.contains("/0)") {print("Нельзя делить на ноль")}
